  ...
  , moment
    ...
    var BaseModel = Backbone.Model.extend({
      ...
      , _instify: function(attrMap, options){
            ...
            // merge together
            return _.extend({},attrMap,mapInstances);
        }
      ...
      , validate: function(attrs, options){
            ...
            // temp working attrs
            var wattrs = _.extend({}, this.attributes, this._instify(attrs,options))
